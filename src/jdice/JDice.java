...
import JDice.DiceParser;
import JDice.DieRoll;
import JDice.RollResult;
...
public class JDice {
	...
	public JDiceListener(JList resultList,
	    ...
	    this.inputBox=inputBox;// thisinputBox thieu dau .
	    lastEvent=0;
	}
